...
#define SBL_FORCE_BOOT0               0xFE //serialbootloader tool Œ’ ÷÷°
#define SBL_FORCE_BOOT1               0x00
#define SBL_FORCE_BOOT2               0x4D
#define SBL_FORCE_BOOT3               0x04
#define SBL_FORCE_BOOT4               0x49
/* ------------------------------------------------------------------------------------------------
 *                                          Functions
 * ------------------------------------------------------------------------------------------------
 */
